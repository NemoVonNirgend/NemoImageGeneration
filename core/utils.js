...
// 1. CONSTANTS
export const LOG_PREFIX = `[NemoImageGeneration]`;
export const NEMO_EXTENSION_NAME = "NemoImageGeneration";
...
// 2. PATH HELPERS
/**
 * Get the full path to a file within the NemoImageGeneration extension directory.
 * Use this instead of hardcoding 'scripts/extensions/third-party/NemoImageGeneration/...' everywhere.
